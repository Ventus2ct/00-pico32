...
// LRB NOTE: the define xxx y gives compiler warnings, but the define is needed..


#undef CONFIG_NMEA_PARSER_RING_BUFFER_SIZE
#undef CONFIG_NMEA_PARSER_TASK_STACK_SIZE
#undef CONFIG_NMEA_PARSER_TASK_PRIORITY
...
#undef CONFIG_NMEA_STATEMENT_GSA
#undef CONFIG_NMEA_STATEMENT_GSV
#undef CONFIG_NMEA_STATEMENT_RMC
#undef CONFIG_NMEA_STATEMENT_GLL
#undef CONFIG_NMEA_STATEMENT_VTG
#undef CONFIG_NMEA_STATEMENT_GGA

#define CONFIG_NMEA_STATEMENT_GSA y
#define CONFIG_NMEA_STATEMENT_GSV y
#define CONFIG_NMEA_STATEMENT_RMC y
#define CONFIG_NMEA_STATEMENT_GLL y
#define CONFIG_NMEA_STATEMENT_VTG y
#define CONFIG_NMEA_STATEMENT_GGA y
