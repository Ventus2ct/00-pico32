...
#define CONFIG_NMEA_STATEMENT_GSA y // = 1 // = y
#define CONFIG_NMEA_STATEMENT_GSV y // = 1 // = y
#define CONFIG_NMEA_STATEMENT_RMC y // = 1 // = y 
#define CONFIG_NMEA_STATEMENT_GLL y // = 1 // = y 
#define CONFIG_NMEA_STATEMENT_VTG y // = 1 // = y 
#define CONFIG_NMEA_STATEMENT_GGA y // = 1 // = y 
